...
public class edittt {
    ...
    public static void main(String[] args) {
        ...
        pnllegaspi.add(btnlegaspiconfirm);
        ...
        pnlmanila.add(btnmanilaconfirm);
        ...
        pnlmaynilad.add(btnmayniladexit);
        ...
        pnlmaynilad.add(btnmayniladback);
        ...
        pnlmaynilad.add(btnmayniladconfirm);
